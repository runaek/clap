...
func (_ counterDeriver) DeriveKeyValue(a any, s string, opts ...clap.Option) (clap.IKeyValue, error) { // nolint: ireturn
...
func (_ counterDeriver) DerivePosition(a any, s int, opts ...clap.Option) (clap.IPositional, error) { // nolint: ireturn
...
func (_ counterDeriver) DeriveFlag(a any, s string, opts ...clap.Option) (clap.IFlag, error) { // nolint: ireturn
