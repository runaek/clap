...
func (_ intsDeriver) DeriveKeyValue(a any, s string, opts ...clap.Option) (clap.IKeyValue, error) { // nolint: ireturn
...
func (_ intsDeriver) DerivePosition(a any, s int, opts ...clap.Option) (clap.IPositional, error) { // nolint: ireturn
...
func (_ intsDeriver) DeriveFlag(a any, s string, opts ...clap.Option) (clap.IFlag, error) { // nolint: ireturn
