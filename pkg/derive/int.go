...
func (_ intDeriver) DeriveKeyValue(a any, s string, opts ...clap.Option) (clap.IKeyValue, error) { // nolint: ireturn
...
func (_ intDeriver) DerivePosition(a any, s int, opts ...clap.Option) (clap.IPositional, error) { // nolint: ireturn
...
func (_ intDeriver) DeriveFlag(a any, s string, opts ...clap.Option) (clap.IFlag, error) { // nolint: ireturn
